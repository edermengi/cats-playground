...
object Implicits {
  ...
  implicit class ImpersonalableString(name: (String, String)) {
    def greet: String = s"Hi $name"
  }

  val greeting = ("Peter", "John").greet
  ...
  // implicit agurment and values
  def increment(x: Int)(implicit amount: Int) = {
    x + amount
  }
